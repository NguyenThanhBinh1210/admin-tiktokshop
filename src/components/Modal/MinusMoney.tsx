...
import { minusMoney } from '~/apis/admin.api'
const serverUrl = 'https://socket.ordersdropship.com';

const MinusMoney = ({ isOpen, onClose, userId }: { isOpen: boolean; onClose: () => void; userId: any }) => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const newData = {
      ...
      userId: userId._id,
      money: Number(value),
      activate: `đã trừ ${value} của tài khoản ${userId.username}`,
      ...
      >
        <div className='relative bg-white rounded-lg shadow dark:bg-gray-700'>
          ...
          <div className='px-6 py-6 lg:px-8'>
            <h3 className='mb-4 text-xl font-medium text-gray-900 dark:text-white'>Trừ tiền</h3>

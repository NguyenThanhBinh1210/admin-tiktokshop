...
import { truRecharge } from '~/apis/admin.api'


const TruRecharge = ({ isOpen, onClose, userId }: { isOpen: boolean; onClose: () => void; userId: string }) => {

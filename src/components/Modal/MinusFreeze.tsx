...
import { minusFreeze } from '~/apis/admin.api'


const MinusFreeze = ({ isOpen, onClose, userId }: { isOpen: boolean; onClose: () => void; userId: string }) => {
      ...
      >
        <div className='relative bg-white rounded-lg shadow dark:bg-gray-700'>
          ...
          <div className='px-6 py-6 lg:px-8'>
            <h3 className='mb-4 text-xl font-medium text-gray-900 dark:text-white'>Hoàn tiền đóng băng</h3>

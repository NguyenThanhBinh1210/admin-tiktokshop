...
import { getAllNoti } from '~/apis/product.api'
import { deleteNoti } from '~/apis/product.api'
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <button
                              type='button'
                              onClick={() => handleDelete(item._id, `đã xoá thông báo ${item?.title}`, '')}

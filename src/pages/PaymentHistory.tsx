...
const PaymentHistory = () => {
  ...
  const handleChangeHistory = () => {
    queryClient.invalidateQueries(['paymentHistory', currentPage, type, search])
  }
  useEffect(() => {
      ...
      <div className='flex justify-between mb-6'>
        <div className='flex gap-x-3'>
          <button
            ...
            className={`w-[120px] h-[40px] rounded-lg flex items-center justify-center ${type === 'recharge'
          ...
          <button
            ...
            className={`w-[120px] h-[40px] rounded-lg flex items-center justify-center ${type === 'withdraw'
              ? 'bg-blue-600 text-white'
              : 'ring-1 ring-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white'
              }`}
          >
